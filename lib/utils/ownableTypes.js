  ...
  try {
    ...
    await Promise.all([
      ...
      fs.copy(sourceImagePath, outputImagePath).then(() => {
        spinner.text = "Image copied successfully";
      }),
      // Create thumbnail
      sharp(sourceImagePath)
        ...
        .then(() => {
          spinner.text = "Thumbnail created successfully";
        }),
    ]);
...
async function handleMusicOwnable(projectPath, outputDir, metadata, spinner) {
  ...
  try {
    ...
    spinner.text = "Checking required directories...";
    ...
    spinner.text = "Reading asset directories...";
    ...
    spinner.text = "Validating audio file...";
    ...
    spinner.text = "Processing assets...";
    await Promise.all([
      // Copy audio file
      fs
        .copy(
        ...
        .then(() => {
          spinner.text = "Audio file copied successfully";
        }),
      ...
      fs
        ...
        .then(() => {
          spinner.text = "Cover art copied successfully";
        }),
      fs
        .copy(
        ...
        .then(() => {
          spinner.text = "Backdrop copied successfully";
        }),
