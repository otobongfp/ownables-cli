...
2. Add your images to the \`assets/images\` directory
   - Required: Two images
   - Cover art: Name one image with 'cover' or 'front' in the filename (e.g., 'cover.jpg', 'front.png')
   - Backdrop: Name one image with 'backdrop' or 'back' in the filename (e.g., 'backdrop.jpg', 'back.png')
...
- \`assets/\`: Contains your media files and index.html
  ...
  - \`images/\`: Place your cover art and backdrop images here
